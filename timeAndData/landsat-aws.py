...
bounding_boxes = [
    [-74.0, 40.7, -73.9, 40.8],  # New York City
    [-118.25, 34.05, -118.2, 34.1],  # Los Angeles
    [-0.15, 51.5, -0.1, 51.55],  # London
    [151.2, -33.9, 151.3, -33.8],  # Sydney
    [139.7, 35.6, 139.8, 35.7]  # Tokyo
]

# Iterate over the list to perform processing on each region
for bbox in bounding_boxes:
    center_lon, center_lat = sum(bbox[0::2]) / 2, sum(bbox[1::2]) / 2
    logging.info(f"Processing region with center coordinates: ({center_lat}, {center_lon})")
